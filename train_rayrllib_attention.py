...
ppo_config = (
    ...
    .training(
        ...
        entropy_coeff_schedule=[
            ...
            (75000, 0.75),  # Start decreasing entropy around iteration 75
            (100000, 0.01), # Reach low entropy by iteration 100
        ],  # Encourage exploration with lower entropy cost
        vf_loss_coeff=5.0,  # Coefficient for value function loss
...
stop_criteria = {
    'training_iteration': 500 # Specify based on your needs
}

# Define the logging directory
log_dir = f"./tensorboard_logs/attention"
